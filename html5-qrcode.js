...
function showQRCode(text) {
  ...
  var padding = (2*dotsize); // (white area around your QRCode)
  var black = "rgb(0,0,0)";
  var white = "rgb(255,255,255)";
  var QRCodeVersion = 1; // 1-40 see http://www.denso-wave.com/qrcode/qrgene2-e.html
  ...
  try {
    ...
    // eg. L can survive approx 5% damage...etc.
        ...
        var qr = new QRCode(QRCodeVersion, QRErrorCorrectLevel.H); 
   	qr.addData(text);
        qr.changeSize();    //Updates QRCode-Version. Don't use it if you want fixed QRCode-version
        qr.make();
  }
  catch(err) {
  ...
  qrCanvasContext.fillRect(0,0,canvas.width,canvas.height);
